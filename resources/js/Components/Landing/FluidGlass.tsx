...
export default function FluidGlass({
    ...
    // Only render the lens mesh, no demo images, no nav, no typography
    // Canvas must be transparent and allow pointer events for tracking
    return (
        <Canvas
...
const ModeWrapper = memo(function ModeWrapper({
    ...
    useFrame((state, delta) => {
        ...
        gl.setClearColor(0x000000, 0); // transparent background for overlay
    });
    ...
    return (
        <>
            ...
            <mesh
                ...
                {...props}
            >
                {/* Use MeshPhysicalMaterial for overlay glass effect */}
