    ...
    return (
        <section className="bg-white overflow-x-clip" id="pricing-info">
            ...
            <div className="mx-auto max-w px-6 sm:px-10 lg:px-16 xl:px-24 pb-20">
                ...
                <div className="flex flex-col xl:grid xl:grid-cols-12 xl:gap-x-12 xl:items-stretch gap-y-10">
                    {/* --- LEFT COLUMN (cols 1–3) --- */}
                    <div className="xl:col-span-3 flex flex-col justify-between items-start gap-12">
                        {/* 1. Label */}
                        <div className="flex items-center gap-3">
                            <div className="size-[14px] xl:size-[17px] mt-0.5 rounded-[5px] bg-[#FF0000] flex-shrink-0" />
                            <span className="font-bdo font-medium text-[clamp(1rem,1.04vw,1.25rem)] text-black">
                                Program Membership
                            </span>
                        </div>

                        {/* 3. Image — pushed to absolute bottom via mt-auto */}
                    ...
                    <div className="xl:col-span-8 xl:col-start-5 flex flex-col items-start gap-10 xl:gap-14">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 w-full">
                            ...
                            <div className="md:col-span-9 flex flex-col">
                                ...
                                {/* Muted paragraph inside col-span-9 for left-edge alignment with table rows */}
                        ...
                        {/* 4. Button — pushed to absolute bottom via xl:mt-auto to align with image bottom */}
                        <div className="w-full self-start xl:mt-auto xl:pb-1">
