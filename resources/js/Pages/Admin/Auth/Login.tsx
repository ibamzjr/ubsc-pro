            ...
            <style>{`
                *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .u-page {
                    ...
                    background:
                        radial-gradient(ellipse 70% 55% at 65% 18%, #D06030 0%, transparent 60%),
                        radial-gradient(ellipse 55% 45% at 15% 75%, #7B2A0C 0%, transparent 55%),
                        radial-gradient(ellipse 80% 60% at 50% 50%, #A83D1A 0%, transparent 70%),
                        linear-gradient(175deg, #1C0904 0%, #5E2210 28%, #A83D1A 56%, #6A2710 78%, #1C0904 100%);
                }
                ...
                .u-glow-a {
                    ...
                    background: radial-gradient(circle, rgba(220,96,36,0.28) 0%, transparent 65%);
                ...
                .u-glow-b {
                    ...
                    background: radial-gradient(circle, rgba(90,25,8,0.45) 0%, transparent 65%);
                    pointer-events: none; z-index: 1;
